...
menu_keyboard = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton("1-dars"), KeyboardButton("2-dars"), KeyboardButton("3-dars")],
    [KeyboardButton("4-dars"), KeyboardButton("5-dars"), KeyboardButton("6-dars")],
    [KeyboardButton("7-dars")],
    [KeyboardButton("8-dars")]],
...
address_keyboard1.add(KeyboardButton("orqaga"))
address_keyboard2.add(KeyboardButton("orqaga"))
address_keyboard3.add(KeyboardButton("orqaga"))
address_keyboard4.add(KeyboardButton("orqaga"))
address_keyboard5.add(KeyboardButton("orqaga"))
address_keyboard6.add(KeyboardButton("orqaga"))
address_keyboard7.add(KeyboardButton("orqaga"))
address_keyboard8.add(KeyboardButton("orqaga"))
